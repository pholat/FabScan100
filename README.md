...
In this fork I've added USB HID device support - as dedicated electronics is developed.
...
→ I've added some deletes, and releases but to me it still seems that there is leak of memory somewhere.
